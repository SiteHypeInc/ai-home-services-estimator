...
```bash
git remote add encore encore://ai-home-services-estimator-fpdi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-home-services-estimator-fpdi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-home-services-estimator-fpdi/settings/integrations/github)
